...
1. SIF副任务先装配七列明细与核心词候选摘要后回传；主任务确认唯一主锚点和1–3个代表种子；随后Amazon联想与卖家精灵扩词并行。卖家精灵副任务先完成四列表装配再回传，三来源机械合并等待两者和SIF全部回传，并只生成两Sheet第一板块业务工作簿。
2. 清洗完成四Sheet工作簿及Sheet2/3/4唯一去向和行数闭环后，词频统计与关键词分类并行。词频不参与分类判断；最终工作簿装配等待词频分支和第三板块分支全部完成。
